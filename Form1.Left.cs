...
public partial class Form1
{
    ...
    private void InitLeftPanel(List<WeaponData> weapons)
    {
        ...
        nudDamageGenericL = new NumericUpDown { Location = new Point(42, 6), Size = new Size(65, 23), DecimalPlaces = 1, Increment = 1m, Minimum = 0m, Maximum = 999m, Value = 0m };
        nudDamageGenericL.ValueChanged += (s, e) => { UpdateAllDamage(); };
